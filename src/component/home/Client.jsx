...
const Client = () => {
    return (
        <div className="max-w-screen-xl mx-auto px-6 mt-10 text-center flex flex-col items-center">
            ...
            >
                "At Shobha Logistics, client satisfaction is paramount. We cater to a diverse clientele, offering tailored logistics solutions that prioritize efficiency and cost-effectiveness. Our commitment is to exceed expectations, supporting businesses of all sizes in achieving their logistics goals."
            </p>
