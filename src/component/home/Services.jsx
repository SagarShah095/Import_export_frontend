...
const servicesData = [
    ...
    },
    {
        ...
        description: "Experience the speed and efficiency of air transportation with Shobha Logistic Services, ensuring your shipments reach their destination promptly.",
        ...
        <section className="py-16 mt-20 bg-white w-full">
            <div className="max-w-screen-xl mx-auto px-6 text-center flex flex-col items-center">
                ...
                <h3
                    ...
                    data-aos-delay="100"
                >
                    Shobha Logistic Services: Your Trusted Partner in Transportation
                </h3>
                ...
                <p
                    ...
                    data-aos-delay="200"
                >
                    Shobha Logistic Services excels in express shipping, domestic cargo transport, and B2B logistics, offering swift and reliable solutions for your transportation needs, tailored to ensure efficient delivery and seamless business operations.
                </p>
