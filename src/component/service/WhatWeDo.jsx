            ...
            <div className="max-w-screen-xl mx-auto space-y-20">
                ...
                <div className="text-center max-w-[73rem] mx-auto">
                    ...
                    <p className="text-[#6c757d] text-base md:text-xl  text-center font-normal">
                        "Shobha Logistic Services provides comprehensive transportation solutions: Shipway for flexible shipping, By Road for reliable ground transport, and By Air for swift deliveries, ensuring seamless shipment management tailored to your needs."
                    </p>
                </div>
                ...
                <div id="b2b-cargo-service" className="flex md:w-[95%] w-[100%] mx-auto flex-col md:flex-row items-center gap-10 md:gap-2">
                    ...
                    <div className="w-full md:w-1/2 space-y-4">
                        ...
                        <p className="text-[#6c757d] text-lg font-medium  text-justify">
                            Efficient B2B Cargo facilitates seamless freight forwarding, optimizing business supply chains with reliability and cost-effectiveness. In the realm of business-to-business transactions, efficient cargo management plays a pivotal role in maintaining supply chain integrity. Shobha Logistics Courier's B2B Cargo Service addresses this need with tailor-made solutions designed to streamline freight forwarding processes for businesses. Our comprehensive service portfolio covers a spectrum of industries, offering seamless transportation solutions for goods of all sizes and types. With a focus on reliability, transparency, and cost-effectiveness, we empower businesses to optimize their logistics operations, enhance productivity, and drive growth.
                        </p>
                    </div>
                </div>
